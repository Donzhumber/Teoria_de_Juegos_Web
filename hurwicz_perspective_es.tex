...
\begin{reminiscence}
Dado que este volumen está dedicado a la memoria de Elisha Pazner, permítanme comenzar con dos reminiscencias. Conocí a Elisha por primera vez en 1969 o 1970, cuando estaba de visita en Harvard. Elisha me consultó sobre problemas relacionados con su tesis doctoral. Inicialmente, no nos resultó fácil comunicarnos, pero me impresionaron sus percepciones originales y su profundidad.
...
\bibentry{Hurwicz, L., y M. Walker [1983]. ``On the Generic Non-Optimality of Dominant-Strategy Mechanisms with an Application to Pure Exchange.'' Research Paper No. 250, circulated by the Economic Research Bureau, State University of New York at Stonybrook.}
